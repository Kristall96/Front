// UserComplaintStatusTabs.jsx
import { motion } from "framer-motion";

const STATUS_TABS = ["Open", "Under Review", "Resolved", "Closed"];

export default function UserComplaintStatusTabs({
  statusTab,
  setStatusTab,
  counts,
}) {
  return (
    <ul className="flex gap-1.5 bg-[#202a40]/70 p-1 rounded-full shadow border border-blue-900/30 mb-2">
      {STATUS_TABS.map((tab) => {
            ...
            >
              ...
              {isActive && (
                <motion.span
                  ...
                  className="absolute left-1/2 -bottom-1 -translate-x-1/2 h-0.5 w-4/5 rounded-full bg-gradient-to-r from-cyan-400/80 via-blue-400 to-blue-600/70"

...
const ImagePreviewModal = ({ src, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[999] bg-black/70 flex items-center justify-center">
      <div className="relative bg-gray-900 border border-gray-700 rounded-lg p-4 max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        <button
          onClick={onClose}
          className="absolute top-3 right-3 bg-red-600 hover:bg-red-700 w-8 h-8 rounded-full flex items-center justify-center"
...
const ViewProductModal = ({
  ...
  return (
    <>
                ...
                <div className="rounded-xl border border-gray-700 bg-gray-800 p-4 shadow-sm space-y-4">
                  ...
                  <div className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-5 gap-3">
                    {images?.map((img, idx) => (
                      <div
                        key={idx}
                        className="relative group rounded-md overflow-hidden border border-gray-600 hover:border-gray-400 transition cursor-pointer"
                    ...
                    {activeTab === "history" ? (
                      ...
                      [...editHistory]
                        ...
                        .map((entry, idx) => (
                          <div
                            key={idx}
                            className="bg-gray-800 rounded-xl p-5 border border-gray-700 shadow-sm transition duration-200"
                          >
                            ...
                            {/* Edit reason */}
                            <p className="italic text-emerald-300 text-sm mt-2 leading-snug">
      ...
      {previewImage && (
        <div className="fixed inset-0 z-[999] bg-black/80 flex items-center justify-center overflow-hidden">
          {/* Prevent background scroll */}
          <div className="fixed inset-0 bg-black/80 z-[-1]" />

          {/* Scrollable image container with overflow hidden */}
          <div className="relative bg-gray-900 border border-gray-700 rounded-lg p-4 max-w-4xl w-full max-h-[90vh] overflow-hidden shadow-2xl">
            <button
